...
#Input Notes:
#This is the fifth step of this pipeline is designed to be used after completing 03_Identify_Circular_Virus.sh
#This pipeline should begin using the CENOTE-TAKER2 output fasta file final_combined_virus_sequences_CENOTE_META.fna generated using 03_Identify_Circular_Virus.sh

#Output Notes:
#This pipeline will generate a read abundance table that can be used for input into Phyloseq in R (counts2_bowtie.txt)
#The next step in this pipeline is the next step in pipeline is 06. Heatmap_Cress (05_Heatmap_Cress.R)
...
cp CENOTE_META/final_combined_virus_sequences_CENOTE_META.fna ./CENOTE_FINAL.fa

bowtie2-build -f CENOTE_FINAL.fa VContigs_index
